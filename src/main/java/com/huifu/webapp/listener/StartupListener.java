 ...
 */
package com.huifu.webapp.listener;
...
import com.huifu.saturn.common.Constants;
...
public class StartupListener implements ServletContextListener {
	...
	public static void setupContext(ServletContext context) {
		ApplicationContext ctx = WebApplicationContextUtils
				.getRequiredWebApplicationContext(context);
		//TODO LookupManager mgr = (LookupManager) ctx.getBean("lookupManager");

		// get list of possible roles
		//TODO context.setAttribute(Constants.AVAILABLE_ROLES, mgr.getAllRoles());
